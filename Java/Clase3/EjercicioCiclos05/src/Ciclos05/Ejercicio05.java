...
un numero alatorio entre 0-100, y  luego ir pidiendo numeros indicando
"es mayor" o  "es menor" segun sea mayor o menor con respecto a N.
El proceso termina cuando el usaurio aciera y mostramos el numero de intentos hechos
Clase Scanner.
*/
package Ciclos05;

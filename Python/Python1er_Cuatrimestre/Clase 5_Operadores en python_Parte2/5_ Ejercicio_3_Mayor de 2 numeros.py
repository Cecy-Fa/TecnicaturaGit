...
Solicitar al usuario dos valores, determinar
cual es el mayor.
1_Solicitar al usuario dos valores
numero1 (int)
numero2(int)
2_Se Debe imprimir el mayor de los dos números
(La salida debe ser identica a la siguiente):
Digite el valor para numero1:

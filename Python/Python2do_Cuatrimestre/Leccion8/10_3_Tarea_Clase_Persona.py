# Tarea: Con la CLASE PERSONA2: (Video 4 Py)
...
# Objeto n°1
    persona2 = Personas2("Luz", "Gomez", 28)
...
persona2 = Personas2('Flor', 'Romero', 23)
print(persona2.nombre)
print(persona2.apellido)
print(persona2.edad)
...
persona3 = Personas2('Caro', 'Felisa', 21)
print(persona3.nombre)
print(persona3.apellido)
print(persona3.edad)
...
persona4 = Personas2('Naty', 'Lucer', 35)
print(persona4.nombre)
print(persona4.apellido)
print(persona4.edad)
